public class Exc13_9
{
    public static void main( String[] args )
    {
        ...
        f("Famous");    // displays the word you pass it beginning with "F"
        ...
        n("Null");    // displays the word you pass it beginning with "N"
        ...
        w(2323);    // pass it any integer and it will display a word beginning with W
