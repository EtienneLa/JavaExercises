...
public class Exc12_3 extends Canvas {

    public void paint (Graphics g){

        g.setColor(Color.green);
        g.drawLine(10,100,400,100);
        g.drawLine(35,80,380,135);
        g.setColor(Color.blue);
        g.drawLine(50,150,100,180);
        g.setColor(Color.magenta);
        g.drawLine(100,350,300,230);
        g.setColor(Color.red);
        g.drawLine(200,265,250,280);

        g.setColor(Color.black);

        g.drawString("Graphics are pretty neat",500,100);
        g.setFont(new Font("Consclas", Font.PLAIN, 36));
    ...
    public static void main(String[]args){
        ...
        JFrame win = new JFrame("Fonts and friends");
        win.setSize(800,600);
        win.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        Exc12_3 canvas = new Exc12_3();
        win.add(canvas);
        win.setVisible(true);
    }
}
